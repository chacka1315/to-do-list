...
function popUpManager() {
    ...
    content.addEventListener("click", (e) => {
        if (e.target.matches("button.addTaskBtn")) {
            ...
            const project = projectManager.projects.find( project => project.id === projectIdForEdit );
                if (project) {
    ...
    sidebar.addEventListener("click", (e) => {
        ...
        if (addProjectBtn) {
            ...
            projectToEditId = editProjectBtn.dataset.id;
                const project = projectManager.projects.find( project => project.id === projectToEditId );
                if (project) {
