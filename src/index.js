...
const task6 = new Task("Reade Napoleon", "blabla", "today", "2", "It will be fun");
const task7 = new Task("Listen book", "blabla", "today", "3", "It will be fun");
...
const task1 = new Task("Go to gym", "blabla", "today", "3", "It will be fun");
...
const task4 = new Task("Visualize", "blabla", "today", "2", "It will be fun");
